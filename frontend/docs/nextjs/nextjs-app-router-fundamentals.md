...
- Only `page.tsx` files create public routes
...
For more advanced routing patterns (parallel routes, intercepting routes), refer to the `nextjs-advanced-routing` skill.
